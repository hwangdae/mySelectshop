...
import { formatFollowCount } from "@/shared/utils/formatFollowCount";
import { useSession } from "next-auth/react";
import { getFollowers, getFollowing, getUserList } from "@/features/follow/api";
import { TFollow, TUser } from "@/shared/types";
...
const Follow = ({ followTypeParams }: PropsType) => {
